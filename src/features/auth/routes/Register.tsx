...
export const Register: React.FunctionComponent = () => {
    ...
    return (
      ...
      >
        <div className="max-w-md w-full space-y-8">
          <div className="light-bg-card py-8 px-6 shadow-lg rounded-lg text-center border light-border-default">
            ...
            <h2 className="text-2xl font-bold light-text-primary mb-2">Check your email</h2>
            <p className="light-text-secondary mb-6">
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center ${themeColors.background.app} px-4 py-8 transition-colors`}
    >
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Start managing your favorite places
          </p>
        </div>
