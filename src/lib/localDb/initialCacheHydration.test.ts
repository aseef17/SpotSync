...
import { isInitialCacheHydrating, resolveHydrationScopeKey } from '@/lib/localDb/initialCacheHydration';
...
describe('initialCacheHydration', () => {
  it('resolves scope keys from routes', () => {
    ...
    expect(resolveHydrationScopeKey('/list/abc123', 'abc123')).toBe('list:abc123');
