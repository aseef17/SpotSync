...
export const LoadingButton: React.FunctionComponent<LoadingButtonProps> = ({
  ...
  const baseStyles =
    'flex items-center justify-center py-2 px-4 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm focus:outline-none focus:ring-2 focus:ring-offset-2';
  ...
  if (variant === 'warning')
    variantStyles = 'bg-yellow-600 text-white hover:bg-yellow-700 focus:ring-yellow-500';
  if (variant === 'ghost')
    variantStyles =
