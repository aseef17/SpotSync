...
export const OptionsMenu: React.FC<OptionsMenuProps> = ({ options }) => {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      <Menu.Items
        className={`absolute right-0 mt-2 w-56 origin-top-right rounded-lg ${themeColors.background.card} shadow-lg border ${themeColors.border.default} focus:outline-none z-50`}
      >
        <div className="p-1">
