...
export const IconPicker: React.FC<IconPickerProps> = ({
    ...
    const selectedColorObj = COLOR_PALETTES.find((c) => c.name === selectedColor) || COLOR_PALETTES[0];
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2 items-center">
                            ...
                            <button
                                ...
                                className={`w-8 h-8 rounded-full flex items-center justify-center transition-transform hover:scale-110 focus:outline-none ${selectedColor === 'AUTO'
                            ...
                            {COLOR_PALETTES.map((color) => (
                                <button
                                    ...
                                    className={`w-8 h-8 rounded-full ${color.bg} transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-${color.class
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <button
                                    ...
                                    className={`${selectedIcon === 'AUTO' ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'
                                        } relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2`}
                                >
                                    <span
                                        className={`${selectedIcon === 'AUTO' ? 'translate-x-6' : 'translate-x-1'
                                ...
                                <div className="max-h-60 overflow-y-auto pr-1 grid grid-cols-6 gap-2 custom-scrollbar">
                                    ...
                                    {AVAILABLE_ICONS.filter((icon) =>
                                        icon.toLowerCase().includes(searchQuery.toLowerCase())
                                            ...
                                            <div className={`col-span-6 text-center py-8 text-sm ${themeColors.text.secondary}`}>
                                                No icons found
                                            </div>
                                        )}
                                </div>
