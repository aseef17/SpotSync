...
exports.askList = onCall({ region: 'us-east4' }, async (request) => {
    ...
    try {
        ...
        try {
            ...
            console.log(JSON.stringify({ severity: "WARNING", message: "Gemini Flash Latest failed, retrying with Lite", error: e1.message }));
            ...
            try {
                ...
                result = await modelLite.generateContent(prompt);
                    ...
                    console.error(JSON.stringify({ severity: "ERROR", message: "Gemini Flash Lite also failed", error: e2.message }));
        ...
        console.error(JSON.stringify({ severity: "ERROR", message: "Error in askList", error: error.message }));
